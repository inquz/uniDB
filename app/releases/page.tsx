...
export default async function ReleasesPage() {
  ...
  return (
    <main className="relative mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
      ...
      <section className={`${panelClass} relative z-20 mb-8 p-4 sm:p-5`}>
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-sky-200/70 bg-sky-50/80 text-sky-700 shadow-[0_8px_20px_rgba(56,189,248,0.12)] dark:border-cyan-400/20 dark:bg-cyan-500/10 dark:text-cyan-200 dark:shadow-[0_0_20px_rgba(34,211,238,0.12)]">
            <svg
              ...
              className="h-5 w-5"
            >
              <path d="M4.5 6.75A2.25 2.25 0 0 1 6.75 4.5h10.5A2.25 2.25 0 0 1 19.5 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 17.25V6.75Zm3.75.75a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5Zm0 4.5a.75.75 0 0 0 0 1.5H12a.75.75 0 0 0 0-1.5H8.25Zm0 4.5a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-4.5Z" />
            </svg>
          </div>

          <div>
            <div className="font-medium text-zinc-800 dark:text-zinc-100">
              Добавить факт выпуска
            </div>
            <div className="text-sm text-zinc-500 dark:text-zinc-400">
              Цех, изделие и количество
            </div>
          </div>
        </div>
            ...
            >
              <div className="mb-4 flex items-start justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <div className="inline-flex items-center rounded-xl border border-sky-200/80 bg-sky-50/70 px-3 py-1 text-sm font-medium text-sky-700 dark:border-cyan-400/20 dark:bg-cyan-500/10 dark:text-cyan-200">
                    Кол-во: {release.quantity}
                  </div>
                </div>
      ...
      <div className={`${panelClass} relative z-0 hidden overflow-x-auto md:block`}>
              ...
              return (
                ...
                >
                  <td className="p-4 align-middle">
                    <div className="max-w-[220px] break-words font-medium text-zinc-900 dark:text-zinc-100">
                      {workshop?.workshopname ?? `Workshop #${release.workshopid}`}
                    </div>
                  </td>

                  <td className="p-4 align-middle">
                    <div className="max-w-[320px] break-words font-medium text-zinc-900 dark:text-zinc-100">
                      {product
                        ? `${product.productcode} — ${product.productname}`
                        : `Product #${release.productid}`}
                    </div>
